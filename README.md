...
- [ntp-display.ino](ntp-display/ntp-display.ino)
    - ![ESP32](media/IMG_7966.jpg)
    - Connects to WiFi, grabs the current UTC time from an NTP server, and displays it.  (Work in progress.)
